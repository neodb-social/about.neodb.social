---
title: "条目编辑说明"
date: 2025-02-22T13:52:24+08:00
draft: false
---
...
点击任一“外部网站”按钮可展开“重新获取”按钮，其功能为从上游站重新获取条目元数据并覆盖现有数据，所以在点击此按钮前，请提前确认该上游站的元数据是否正确。
...
- Edition：大部分出版物有 ISBN (或ASIN) 就能合并
  - 起点/阅评说/晋江：大部分阅评说条目能分别与起点、晋江条目合并。
  - 全站统一使用ISBN13，大部分ISBN10会被自动转换为ISBN13
- Game：大部分情况下需手动操作
  - IGDB、Steam 之间大部分时候能自动合并
- Album
  - Douban / Spotify / Discogs 偶尔通过条形码（也称UPC）可以自动合并
...
目前可在[Discord](https://discord.gg/8KweCuApaK)申请成为旗舰站（neodb.social、eggplant.place）的条目管理员。**请务必审慎使用管理权限，如有不确定的操作请在相关帖子与他人讨论。**
